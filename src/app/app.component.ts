...
export class AppComponent {
  ...
  getClass(square){
  	if (this.green.indexOf(square) > -1){
  		return 'tree-green'
  	} else if (this.black.indexOf(square) > -1){
  		return 'tree-black'
  	} else if (this.yellow.indexOf(square) > -1){
  		return 'tree-yellow'
  	} else if (this.red.indexOf(square) > -1){
  		return 'tree-red'
  	} else if (this.blue.indexOf(square) > -1){
  		return 'tree-blue'
  	} else if (this.orn_green.indexOf(square) > -1){
  		return 'tree-orn-green'
  	} else if (this.brown.indexOf(square) > -1){
  		return 'tree-brown'
  	} else if (this.white.indexOf(square) > -1){
  		return 'tree-white'
  	} else {
  		return 'gray'
  	}
